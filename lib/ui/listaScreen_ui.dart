              ...
              children: [
                IconButton(
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(tarefa.nome, style: const TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                      Text(tarefa.data.toString()),
                    ],
                  ),
              ],
        ...
        body:  Column(
          ...
          children: [
            Container(
              ...
              child: TextField(
                controller: _acaoTarefa.controller,
                onSubmitted: _acaoTarefa.adicionaTarefa,
              ),
            ),
            Expanded(child: 
              ListView.builder(
              itemCount: _acaoTarefa.tarefas.length,
              itemBuilder: (_, indice){
                return getItem(_acaoTarefa.tarefas[indice]);
              },
